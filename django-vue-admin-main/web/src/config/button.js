...
//export const BUTTON_cBOOK_BOOL = getButtonSettings([{ label: '预订', value: true }, { label: '取消', value: false },{ label: '通过申请', value: false },{ label: '拒绝申请', value: false }])

export const BUTTON_ADMIN_BOOL = getButtonSettings([{ label: '待审批', value: true }, { label: '同意', value: false }])
